                                        ...
                                        <tr>
                                            ...
                                            <form id="delete_{{$owner->id}}" method="post" action="{{route('admin.expired-owners.destroy', ['owner'=>$owner->id])}}">
                                                ...
                                                <td class="w-10 text-center">
                                                    <a href="#" data-id="{{$owner->id}}" onclick="deletePost(this)" class="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded">完全に削除</a>
                                                </td>
                                            </form>
                                        </tr>
                                    @endforeach
