                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                            ...
                            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 mx-auto">オーナー情報編集</h1>
                            </div>
                                    ...
                                    <div class="-m-2">
                                        <div class="p-2 w-1/2 mx-auto">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="name" name="name" value="{{$owner->name}}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="p-2 w-1/2 mx-auto">
                                            <div class="relative">
                                                ...
                                                <input type="email" id="email" name="email" value="{{$owner->email}}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
