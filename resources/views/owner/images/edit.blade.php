                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form id="delete_{{$image->id}}" method="post" action="{{route('owner.images.destroy', ['image'=>$image->id])}}">
                        ...
                        <div class="p-2 w-full mt-32 flex justify-around">
                            <a href="#" data-id="{{$image->id}}" onclick="deletePost(this)" class="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded">削除する</a>
                        </div>
                    </form>
                </div>
            </div>
